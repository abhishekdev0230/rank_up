...
class ImportantTopicsScreen extends StatefulWidget {
  ...
  const ImportantTopicsScreen({super.key, required this.isPremium});
...
class _ImportantTopicsScreenState extends State<ImportantTopicsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<ImportantTopicsProvider>(
        context,
        listen: false,
      );
        ...
        builder: (context, provider, _) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              final bool isPremiumUser = widget.isPremium == "true";
              final bool isLocked = !isPremiumUser;
